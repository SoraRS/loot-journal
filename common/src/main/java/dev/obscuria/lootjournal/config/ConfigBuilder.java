    ...
    public static Screen createConfigScreen(Screen parent) {
        ...
        return YetAnotherConfigLib.createBuilder()
                ...
                .category(cat("tracking")
                        ...
                        .option(Opts.list(Config.PLAYER_WHITELIST, "Nickname"))
                        .build())
                .category(cat("sounds")
                ...
                .category(cat("filtering")
                        ...
                        .option(Opts.list(Config.ITEM_ID_BLACKLIST, "minecraft:apple"))
                        .option(Opts.list(Config.ITEM_ID_WHITELIST, "minecraft:apple"))
                        .option(Opts.list(Config.ITEM_TAG_BLACKLIST, "minecraft:music_discs"))
                        .option(Opts.list(Config.ITEM_TAG_WHITELIST, "minecraft:music_discs"))
                        .option(Opts.list(Config.MOD_ID_BLACKLIST, "mod_id"))
                        .option(Opts.list(Config.MOD_ID_WHITELIST, "mod_id"))
                        .build())
    ...
    public final static class Opts {
        ...
        private static <T> Option.Builder<T> base(ConfigValue<T> v) {
            return Option.<T>createBuilder()
                    .name(tr("option." + v.name()))
                    .description(description(tr("option." + v.name() + ".desc")))
                    .binding(bind(v));
        }
